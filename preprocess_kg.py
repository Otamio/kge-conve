...
# Load dictionary
vocab_e = np.load(f"{str(Path.home())}/{os.environ['OUTPUT']}/{args.dataset}/vocab_e1", allow_pickle=True)
vocab_r = np.load(f"{str(Path.home())}/{os.environ['OUTPUT']}/{args.dataset}/vocab_rel", allow_pickle=True)
